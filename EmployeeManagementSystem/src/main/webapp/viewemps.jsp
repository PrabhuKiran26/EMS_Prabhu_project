...
<body >
    ...
    <div id="home" class="container">
      ...
      <td><a href = 'editemp.jsp?id=${employee.id}&name=${employee.name}&email=${employee.email}&password=${employee.password}&age=${employee.age}&department=${employee.department}&mobileno=${employee.mobile}&gender=${employee.gender}&address=${employee.address}'>Edit</a></td>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            	    home: 'url("https://t3.ftcdn.net/jpg/15/34/52/54/240_F_1534525494_BkiNTZTbGm1NEbWMJVUipjVqIGrRAGc0.jpg")',
